    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMoviesLists", x => x.id);
                    table.ForeignKey(
                        name: "FK_UserMoviesLists_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMoviesLists_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMoviesLists_MovieId",
                table: "UserMoviesLists",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMoviesLists_UserId",
                table: "UserMoviesLists",
                column: "UserId");
        }
